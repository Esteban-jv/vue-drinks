...
<script setup>
  ...
  const formatearIngredientes = () => {
    ...
    for(let i=1; i<= 15; i++) {
      if(bebidas.recepy[`strIngredient${i}`]) {
        const ingrediente = bebidas.recepy[`strIngredient${i}`]
        const cantidad = bebidas.recepy[`strMeasure${i}`]
                ...
                <div>
                  <div class="mt-3">
                    <DialogTitle as="h3" class="text-gray-900 text-4xl font-extrabold my-5">
                      {{ bebidas.recepy.strDrink }}
                    </DialogTitle>
                    <img
                      :src="bebidas.recepy.strDrinkThumb"
                      :alt="'Bebida de ' + bebidas.recepy.strDrink"
                      class="mx-auto w-96"
                    />
                    <DialogTitle as="h3" class="text-gray-900 text-4xl font-extrabold my-5">
                    ...
                    <p class="text-lg text-gray-500">
                      {{ bebidas.recepy.strInstructions }}
                    </p>
                  </div>
                </div>
